      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-14 mb-12">
          ...
          <div>
            ...
            <a
              href="#contact"
              className="inline-block bg-gradient-to-r from-[#E78F00] to-[#3C8DD4] text-white font-semibold px-5 py-2 rounded-full text-sm md:text-base hover:opacity-90 transition-all shadow-md"
            >
              Hubungi Kami
            </a>
          </div>
