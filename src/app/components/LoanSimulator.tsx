...
export default function LoanSimulator() {
  ...
  return (
    <section
      id="simulator"
      className="py-14 sm:py-20 px-4 bg-gradient-to-b from-blue-50 to-white"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Gunakan kalkulator di bawah untuk menghitung estimasi pinjaman
        ...
        <div className="bg-white rounded-3xl shadow-xl sm:shadow-2xl p-6 sm:p-10 md:p-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-8 sm:mb-10 p-5 sm:p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl">
            ...
            <div className="text-center sm:text-left w-full">
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                Pencairan hingga 95% dari nilai kendaraan
              </p>
            </div>
          </div>
          ...
          {/* Info Bunga */}
          <div className="mt-8 mb-8 sm:mb-10 p-4 bg-orange-50 border-l-4 border-orange-400 rounded-lg flex items-start gap-3">
            <Percent className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0" />
            <div>
              <div className="font-semibold text-orange-800 text-sm sm:text-base">
                Bunga Kompetitif
              </div>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl p-6 sm:p-8 md:p-10 text-white shadow-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
              <div className="text-center py-4 sm:py-5 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                <div className="text-blue-100 text-xs sm:text-sm mb-1 font-medium">
                  Total Bunga
                </div>
            ...
            <p className="pt-4 border-t border-white/30 text-blue-100 text-xs sm:text-sm text-center leading-relaxed">
              * Simulasi ini hanya perkiraan. Nilai aktual bergantung pada hasil
              survei dan mitra pembiayaan resmi berizin OJK.
            </p>
          </div>
